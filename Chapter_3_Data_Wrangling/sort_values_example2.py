...
df.sort_values(inplace=True, by=['birth_year'])  # sorts birth_year numerically (smallest first)
print(df)

df.sort_values(inplace=True, by=['title'])  # sorts title alphabetically (A-Z)
print(df)

# sorts numerically in descending order:
df.sort_values(inplace=True, by=['birth_year'], ascending=False)  
print(df)

# sorts title then birth_year:
df.sort_values(inplace=True, by=['title', 'birth_year'])  
print(df)
