...
for line in lines:
    ...
    if '<span class="ingredients-item-name">' in line:
        ingredient = line.split('<span class="ingredients-item-name">')
        ingredient_text = ingredient[1]
        end_of_ingredient_text = ingredient_text.find(' </span>')
        ingredient_text = ingredient_text[:end_of_ingredient_text]
